                        ...
                        <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                            ...
                            >
                                ...
                                <p className="text-center text-sm text-gray-500">
                                    ...
                                    <Link to="/signin" onClick={onFormSwitch} className="font-medium text-indigo-600 hover:text-indigo-500">
                                        {' '}Sign In
                                    </Link>
                                </p>
                            </form>
                ...
                <div className="bg-white">
                    <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                        ...
                        >
                            ...
                            <p className="text-center text-sm text-gray-500">
                                No Account?
                                <Link onClick={onFormSwitch} className="font-medium text-indigo-600 hover:text-indigo-500">
                                    {' '}Sign Up
                                </Link>
                            </p>
                        </form>
